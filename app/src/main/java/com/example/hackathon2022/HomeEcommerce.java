...
public class HomeEcommerce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_ecommerce);
    ...
    protected void initComponents() {
        ...
        RecyclerView recyclerView = findViewById(R.id.activityhomeecommerce_recycleview);
        searchbar = findViewById(R.id.activityhomeecommerce_searchbar);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if(Objects.requireNonNull(postSnapshot.getValue(ObjectForum.class)).getKategori().equals("E-Commerce")) {
                ...
                myAdapter.setOnItemClickListener(new AllForumAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, String key, String username, String judul, String kategori, String pertanyaan, String date, String star, String path) {
                        Intent i = new Intent(HomeEcommerce.this, ForumCardPage.class);
                        i.putExtra("key",key);
    ...
    public void SearchingEcommerce(View view) {
        ArrayList<ObjectForum> newList = new ArrayList<>();
        RecyclerView recyclerView = findViewById(R.id.activityhomeecommerce_recycleview);
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void SortingEcommerce(View view) {
        ArrayList<ObjectForum> newList = new ArrayList<>();
