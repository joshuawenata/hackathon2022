...
public class HomeSocialMedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_social_media);
    ...
    protected void initComponents() {
        ...
        RecyclerView recyclerView = findViewById(R.id.activityhomesocialmedia_recycleview);
        searchbar = findViewById(R.id.activityhomesocialmedia_searchbar);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if(Objects.requireNonNull(postSnapshot.getValue(ObjectForum.class)).getKategori().equals("Social Media")) {
                ...
                myAdapter.setOnItemClickListener(new AllForumAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, String key, String username, String judul, String kategori, String pertanyaan, String date, String star, String path) {
                        Intent i = new Intent(HomeSocialMedia.this, ForumCardPage.class);
                        i.putExtra("key",key);
    ...
    public void SortingSocialMedia(View view) {
        ArrayList<ObjectForum> newList = new ArrayList<>();
