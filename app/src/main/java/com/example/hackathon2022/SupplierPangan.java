...
public class SupplierPangan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplier_pangan);
    ...
    protected void initComponents() {
        ...
        RecyclerView recyclerView = findViewById(R.id.activitysupplierpangan_recycleview);

        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("users");
        searchbar = findViewById(R.id.activitysupplierpangan_searchbar);

        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if(postSnapshot.getValue(ObjectUser.class).getKategori().equals("Pangan")&&postSnapshot.getValue(ObjectUser.class).getRole().equals("users")){
                ...
                myAdapter.setOnItemClickListener(new AllSupplierAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(String key, String judul, String category, String description, String nomor, String date, String star, String backgroundimagepath) {
                        Intent i = new Intent(SupplierPangan.this, SupplierCardPage.class);
                        i.putExtra("key", key);
    ...
    public void SearchingSupplierPangan(View view) {
        ArrayList<ObjectUser> newList = new ArrayList<>();
        RecyclerView recyclerView = findViewById(R.id.activitysupplierpangan_recycleview);
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if(Objects.requireNonNull(postSnapshot.getValue(ObjectUser.class)).getKategori().equals("Pangan")&&postSnapshot.getValue(ObjectUser.class).getRole().equals("users")){
    ...
    public void sortPangan(View view) {
        ArrayList<ObjectUser> newList = new ArrayList<>();
