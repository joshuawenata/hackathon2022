...
public class SupplierTransportasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_supplier_transportasi);
    ...
    protected void initComponents() {
        ...
        RecyclerView recyclerView = findViewById(R.id.activitysuppliertransportasi_recycleview);

        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("users");
        searchbar = findViewById(R.id.activitysuppliertransportasi_searchbar);

        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if(postSnapshot.getValue(ObjectUser.class).getKategori().equals("Transportasi")&&postSnapshot.getValue(ObjectUser.class).getRole().equals("users")){
                ...
                myAdapter.setOnItemClickListener(new AllSupplierAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(String key, String judul, String category, String description, String nomor, String date, String star, String backgroundimagepath) {
                        Intent i = new Intent(SupplierTransportasi.this, SupplierCardPage.class);
                        i.putExtra("key", key);
    ...
    public void SearchingSupplierTransportasi(View view) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if(Objects.requireNonNull(postSnapshot.getValue(ObjectUser.class)).getKategori().equals("Transportasi")&&postSnapshot.getValue(ObjectUser.class).getRole().equals("users")){
    ...
    public void sortTransportasi(View view) {
        ArrayList<ObjectUser> newList = new ArrayList<>();
